...
// source: pkg/contracts-v0.2.1/api/mediasoft-internship/final-task/contracts/restaurant/restaurant_menu.proto
...
func request_MenuService_CreateMenu_0(ctx context.Context, marshaler runtime.Marshaler, client restaurant.MenuServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq restaurant.CreateMenuRequest
...
func local_request_MenuService_CreateMenu_0(ctx context.Context, marshaler runtime.Marshaler, server restaurant.MenuServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq restaurant.CreateMenuRequest
	var metadata runtime.ServerMetadata
...
func request_MenuService_GetMenu_0(ctx context.Context, marshaler runtime.Marshaler, client restaurant.MenuServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq restaurant.GetMenuRequest
	var metadata runtime.ServerMetadata
...
func local_request_MenuService_GetMenu_0(ctx context.Context, marshaler runtime.Marshaler, server restaurant.MenuServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq restaurant.GetMenuRequest
	var metadata runtime.ServerMetadata
...
func RegisterMenuServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server restaurant.MenuServiceServer) error {
	...
	mux.Handle("POST", pattern_MenuService_CreateMenu_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mediasoft.internship.final.task.contracts.restaurant.MenuService/CreateMenu", runtime.WithHTTPPathPattern("/restaurant/menu"))
		if err != nil {
	...
	mux.Handle("GET", pattern_MenuService_GetMenu_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mediasoft.internship.final.task.contracts.restaurant.MenuService/GetMenu", runtime.WithHTTPPathPattern("/restaurant/menu"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMenuServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterMenuServiceHandlerClient(ctx, mux, restaurant.NewMenuServiceClient(conn))
}
...
func RegisterMenuServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client restaurant.MenuServiceClient) error {
	...
	mux.Handle("POST", pattern_MenuService_CreateMenu_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mediasoft.internship.final.task.contracts.restaurant.MenuService/CreateMenu", runtime.WithHTTPPathPattern("/restaurant/menu"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MenuService_GetMenu_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mediasoft.internship.final.task.contracts.restaurant.MenuService/GetMenu", runtime.WithHTTPPathPattern("/restaurant/menu"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
