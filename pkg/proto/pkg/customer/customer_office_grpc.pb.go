...
const (
	OfficeService_CreateOffice_FullMethodName  = "/foodordering.customer.OfficeService/CreateOffice"
	OfficeService_GetOfficeList_FullMethodName = "/foodordering.customer.OfficeService/GetOfficeList"
)
...
func (c *officeServiceClient) GetOfficeList(ctx context.Context, in *GetOfficeListRequest, opts ...grpc.CallOption) (*GetOfficeListResponse, error) {
	...
	err := c.cc.Invoke(ctx, OfficeService_GetOfficeList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OfficeService_GetOfficeList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OfficeService_GetOfficeList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OfficeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodordering.customer.OfficeService",
	...
	Metadata: "customer_office.proto",
}
