...
const (
	OrderService_GetUpToDateOrderList_FullMethodName = "/foodordering.restaurant.OrderService/GetUpToDateOrderList"
)
...
func (c *orderServiceClient) GetUpToDateOrderList(ctx context.Context, in *GetUpToDateOrderListRequest, opts ...grpc.CallOption) (*GetUpToDateOrderListResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderService_GetUpToDateOrderList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderService_GetUpToDateOrderList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_GetUpToDateOrderList_FullMethodName,
	}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodordering.restaurant.OrderService",
